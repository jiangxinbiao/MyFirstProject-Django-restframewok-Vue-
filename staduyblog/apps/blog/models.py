...
class Article(models.Model):
    title = models.CharField(verbose_name='文章',max_length=50,null=True,blank=True)
    photo = models.ImageField(verbose_name='插图', upload_to='avatar', height_field='url_height', width_field='url_width')
    ...
    updatedtime = models.DateTimeField(verbose_name='修改时间', auto_now=True)
    text = UEditorField(verbose_name=u'正文', width=850, height=500, toolbars="full", imagePath="media/images/", filePath="media/files/",
...
class Comments(models.Model):
    post = models.ForeignKey(Article,verbose_name='作品',on_delete=models.CASCADE,null = True)
